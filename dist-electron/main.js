import Ct, { ipcMain as Tr, app as kt, BrowserWindow as Rl, session as tc } from "electron";
import Ut from "node:path";
import { fileURLToPath as rc } from "node:url";
import pt from "fs";
...
import Pl from "zlib";
import ac from "http";
var Qe = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, _t = {}, Kr = {}, Cr = {}, Sa;
function Ve() {
  return Sa || (Sa = 1, Cr.fromCallback = function(t) {
...
function oc() {
  if (Aa) return Jr;
  Aa = 1;
  var t = nc, f = process.cwd, h = null, u = process.env.GRACEFUL_FS_PLATFORM || process.platform;
...
function je() {
  if (Ca) return br;
  Ca = 1;
  var t = pt, f = oc(), h = sc(), u = lc(), c = Ki, l, a;
...
GFS4: `), console.error(p);
    ...
    i(t, r), t.close = (function(p) {
      ...
      s(t[l]), Tl.equal(t[l].length, 0);
    });
  }
  Qe[l] || i(Qe, t[l]), br = o(u(t)), process.env.TEST_GRACEFUL_FS_GLOBAL_PATCH && !t.__patched && (br = o(t), t.__patched = !0);
  function o(p) {
...
function cc() {
  if (Oa) return Pr;
  Oa = 1;
  const t = /* @__PURE__ */ $t(), { checkPath: f } = /* @__PURE__ */ uc(), h = (u) => {
    const c = { mode: 511 };
    return typeof u == "number" ? u : { ...c, ...u }.mode;
  };
  return Pr.makeDir = async (u, c) => (f(u), t.mkdir(u, {
    mode: h(c),
    recursive: !0
  })), Pr.makeDirSync = (u, c) => (f(u), t.mkdirSync(u, {
    mode: h(c),
    recursive: !0
  })), Pr;
}
...
function nt() {
  if (Ia) return tn;
  Ia = 1;
  const t = Ve().fromPromise, { makeDir: f, makeDirSync: h } = /* @__PURE__ */ cc(), u = t(f);
  return tn = {
    mkdirs: u,
    mkdirsSync: h,
    // alias
...
function bt() {
  if (Da) return rn;
  Da = 1;
  const t = Ve().fromPromise, f = /* @__PURE__ */ $t();
  function h(u) {
...
function Mt() {
  ...
  function a(n, m, v, y) {
    ...
    if (S) {
      if (s(p, S)) {
        const T = f.basename(n), P = f.basename(m);
  ...
  function d(n, m, v, y, p) {
    const S = f.resolve(f.dirname(n)), T = f.resolve(f.dirname(v));
    if (T === S || T === f.parse(T).root) return p();
...
function fc() {
  if (xa) return on;
  xa = 1;
  const t = je(), f = Ie, h = nt().mkdirs, u = bt().pathExists, c = Ol().utimesMillis, l = /* @__PURE__ */ Mt();
  function a(U, L, $, D) {
  ...
  function m(U, L, $, D, F) {
    t.copyFile(L, $, (j) => j ? F(j) : D.preserveTimestamps ? v(U.mode, L, $, F) : T($, U.mode, F));
  }
  function v(U, L, $, D) {
...
function dc() {
  if (La) return sn;
  La = 1;
  const t = je(), f = Ie, h = nt().mkdirsSync, u = Ol().utimesMillisSync, c = /* @__PURE__ */ Mt();
  function l(_, A, E) {
  ...
  function S(_, A, E, q, U) {
    return A ? P(E, q, U) : T(_.mode, E, q, U);
  }
  function T(_, A, E, q) {
...
function hc() {
  if (ka) return un;
  ka = 1;
  const t = je(), f = Ie, h = Tl, u = process.platform === "win32";
  function c(v) {
    [
      "unlink",
      "chmod",
  ...
  function l(v, y, p) {
    let S = 0;
    typeof y == "function" && (p = y, y = {}), h(v, "rimraf: missing path"), h.strictEqual(typeof v, "string", "rimraf: path should be a string"), h.strictEqual(typeof p, "function", "rimraf: callback function required"), h(y, "rimraf: invalid options argument provided"), h.strictEqual(typeof y, "object", "rimraf: options should be object"), c(y), a(v, y, function T(P) {
      if (P) {
  ...
  return un = l, l.sync = o, un;
}
var cn, qa;
function Br() {
  if (qa) return cn;
  qa = 1;
  const t = je(), f = Ve().fromCallback, h = /* @__PURE__ */ hc();
  function u(l, a) {
...
function pc() {
  if ($a) return fn;
  $a = 1;
  const t = Ve().fromPromise, f = /* @__PURE__ */ $t(), h = Ie, u = /* @__PURE__ */ nt(), c = /* @__PURE__ */ Br(), l = t(async function(i) {
    let s;
    try {
      s = await f.readdir(i);
    } catch {
...
function gc() {
  if (Ba) return hn;
  Ba = 1;
  const t = Ve().fromCallback, f = Ie, h = je(), u = /* @__PURE__ */ nt(), c = bt().pathExists, { areIdentical: l } = /* @__PURE__ */ Mt();
  function a(i, s, r) {
    function o(n, m) {
      h.link(n, m, (v) => {
        if (v) return r(v);
...
function yc() {
  if (Ga) return gn;
  Ga = 1;
  const t = Ve().fromCallback, f = Ie, h = /* @__PURE__ */ $t(), u = /* @__PURE__ */ nt(), c = u.mkdirs, l = u.mkdirsSync, a = /* @__PURE__ */ vc(), d = a.symlinkPaths, i = a.symlinkPathsSync, s = /* @__PURE__ */ Ec(), r = s.symlinkType, o = s.symlinkTypeSync, n = bt().pathExists, { areIdentical: m } = /* @__PURE__ */ Mt();
  function v(S, T, P, O) {
...
function wc() {
  if (Wa) return vn;
  Wa = 1;
  const { createFile: t, createFileSync: f } = /* @__PURE__ */ mc(), { createLink: h, createLinkSync: u } = /* @__PURE__ */ gc(), { createSymlink: c, createSymlinkSync: l } = /* @__PURE__ */ yc();
  return vn = {
    // file
    createFile: t,
    createFileSync: f,
...
`, finalEOL: c = !0, replacer: l = null, spaces: a } = {}) {
  ...
  return En = { stringify: t, stripBom: f }, En;
}
var yn, Ya;
function _c() {
  if (Ya) return yn;
  ...
  const f = Ve(), { stringify: h, stripBom: u } = Qi();
...
function Ac() {
  if (Ka) return Sn;
  Ka = 1;
  const { stringify: t } = Qi(), { outputFile: f } = /* @__PURE__ */ Zi();
...
function Rc() {
  if (Ja) return An;
  Ja = 1;
  const { stringify: t } = Qi(), { outputFileSync: f } = /* @__PURE__ */ Zi();
  function h(u, c, l) {
    const a = t(c, l);
    f(u, a, l);
  }
...
function Tc() {
  if (Qa) return Rn;
  Qa = 1;
  const t = Ve().fromPromise, f = /* @__PURE__ */ Sc();
  return f.outputJson = t(/* @__PURE__ */ Ac()), f.outputJsonSync = /* @__PURE__ */ Rc(), f.outputJSON = f.outputJson, f.outputJSONSync = f.outputJsonSync, f.writeJSON = f.writeJson, f.writeJSONSync = f.writeJsonSync, f.readJSON = f.readJson, f.readJSONSync = f.readJsonSync, Rn = f, Rn;
}
var Tn, Za;
function Cc() {
  if (Za) return Tn;
  Za = 1;
  const t = je(), f = Ie, h = Ji().copy, u = Br().remove, c = nt().mkdirp, l = bt().pathExists, a = /* @__PURE__ */ Mt();
  function d(n, m, v, y) {
...
function bc() {
  if (eo) return Cn;
  eo = 1;
  const t = je(), f = Ie, h = Ji().copySync, u = Br().removeSync, c = nt().mkdirpSync, l = /* @__PURE__ */ Mt();
  function a(o, n, m) {
    m = m || {};
...
function ea() {
  if (no) return At;
  no = 1, Object.defineProperty(At, "__esModule", { value: !0 }), At.CancellationError = At.CancellationToken = void 0;
  const t = Cl;
...
function Hr() {
  if (io) return Or;
  io = 1, Object.defineProperty(Or, "__esModule", { value: !0 }), Or.newError = t;
  function t(f, h) {
    const u = new Error(f);
    return u.code = h, u;
  }
...
var ke = {}, Ir = { exports: {} }, Dr = { exports: {} }, In, ao;
function Oc() {
  if (ao) return In;
  ao = 1;
...
function Il() {
  ...
  oo = 1;
  function t(f) {
    u.debug = u, u.default = u, u.coerce = s, u.disable = d, u.enable = l, u.enabled = i, u.humanize = Oc(), u.destroy = r, Object.keys(f).forEach((o) => {
      u[o] = f[o];
...
var Nr = { exports: {} }, Nn, lo;
function Dc() {
  return lo || (lo = 1, Nn = (t, f = process.argv) => {
...
function Nc() {
  if (uo) return Fn;
  uo = 1;
  const t = Mr, f = bl, h = Dc(), { env: u } = process;
  let c;
...
var fo;
function xc() {
  return fo || (fo = 1, typeof process > "u" || process.type === "renderer" || process.browser === !0 || process.__nwjs ? Ir.exports = Ic() : Ir.exports = Fc()), Ir.exports;
}
var Vt = {}, ho;
function Dl() {
  if (ho) return Vt;
  ho = 1, Object.defineProperty(Vt, "__esModule", { value: !0 }), Vt.ProgressCallbackTransform = void 0;
  const t = pr;
  ...
  return Vt.ProgressCallbackTransform = f, Vt;
}
var po;
function Lc() {
  if (po) return ke;
  po = 1, Object.defineProperty(ke, "__esModule", { value: !0 }), ke.DigestTransform = ke.HttpExecutor = ke.HttpError = void 0, ke.createHttpError = s, ke.parseJson = n, ke.configureRequestOptionsFromUrl = v, ke.configureRequestUrl = y, ke.safeGetHeader = T, ke.configureRequestOptions = O, ke.safeStringifyJson = M;
  const t = mr, f = xc(), h = pt, u = pr, c = qt, l = ea(), a = Hr(), d = Dl(), i = (0, f.default)("electron-builder");
  function s(C, _ = null) {
...
function Uc() {
  if (mo) return Yt;
  mo = 1, Object.defineProperty(Yt, "__esModule", { value: !0 }), Yt.MemoLazy = void 0;
  let t = class {
    constructor(u, c) {
...
function kc() {
  if (go) return zt;
  go = 1, Object.defineProperty(zt, "__esModule", { value: !0 }), zt.githubUrl = t, zt.getS3LikeProviderBaseUrl = f;
...
function qc() {
  if (vo) return Fr;
  vo = 1, Object.defineProperty(Fr, "__esModule", { value: !0 }), Fr.retry = f;
  const t = ea();
...
function $c() {
  if (Eo) return xr;
  Eo = 1, Object.defineProperty(xr, "__esModule", { value: !0 }), xr.parseDn = t;
  function t(f) {
...
function Mc() {
  if (yo) return Rt;
  yo = 1, Object.defineProperty(Rt, "__esModule", { value: !0 }), Rt.nil = Rt.UUID = void 0;
  const t = mr, f = Hr(), h = "options.name must be either a string or a Buffer", u = (0, t.randomBytes)(16);
  u[0] = u[0] | 1;
  const c = {}, l = [];
  for (let o = 0; o < 256; o++) {
      ...
      function de(w, g) {
        if (w.opt.xmlns) {
          ...
          for (var he = 0, pe = w.attribList.length; he < pe; he++) {
            var _e = w.attribList[he], ye = _e[0], He = _e[1], Ae = Y(ye, !0), $e = Ae.prefix, lt = Ae.local, it = $e === "" ? "" : H.ns[$e] || "", tt = {
              name: ye,
              value: He,
              prefix: $e,
              local: lt,
            ...
            ), tt.uri = $e), w.tag.attributes[ye] = tt, L(w, "onattribute", tt);
          }
...
function Hc() {
  if (_o) return Nt;
  _o = 1, Object.defineProperty(Nt, "__esModule", { value: !0 }), Nt.XElement = void 0, Nt.parseXml = a;
  const t = Bc(), f = Hr();
  class h {
    constructor(i) {
...
function Fl() {
  ...
  Po = 1;
  var t = Me();
  return $n = new t("tag:yaml.org,2002:str", {
    kind: "scalar",
...
function $l() {
  ...
  return Wn = new f("tag:yaml.org,2002:int", {
    kind: "scalar",
    resolve: l,
    construct: a,
    predicate: d,
...
function Ml() {
  ...
  return Vn = new f("tag:yaml.org,2002:float", {
    kind: "scalar",
    resolve: u,
    construct: c,
    predicate: d,
...
function Gc() {
  if (Wo) return Lr;
  Wo = 1;
  var t = gr(), f = vr(), h = jc(), u = ta(), c = Object.prototype.hasOwnProperty, l = 1, a = 2, d = 3, i = 4, s = 1, r = 2, o = 3, n = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, m = /[\x85\u2028\u2029]/, v = /[,\[\]\{\}]/, y = /^(?:!|!!|![a-z\-]+!)$/i, p = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
  function S(e) {
...
`, B - 1));
  ...
  function w(e, B, G) {
    var re, W, te, Z, ae, le, Re, Te, me = e.kind, R = e.result, k;
  ...
  function N(e, B) {
    var G = !0, re, W, te, Z = e.tag, ae, le = e.anchor, Re, Te, me, R, k, V = /* @__PURE__ */ Object.create(null), z, X, ie, ee;
...
`, te ? 1 + le : le), te = !0, Z = !0, le = 0, G = e.position; !T(me) && me !== 0; )
  ...
  function pe(e, B, G) {
    var re, W, te, Z, ae, le, Re = e.tag, Te = e.anchor, me = {}, R = /* @__PURE__ */ Object.create(null), k = null, V = null, z = null, X = !1, ie = !1, ee;
    if (e.firstTabInLine !== -1) return !1;
    for (e.anchor !== null && (e.anchorMap[e.anchor] = me), ee = e.input.charCodeAt(e.position); ee !== 0; ) {
      if (!X && e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, I(e, "tab characters must not be used in indentation")), re = e.input.charCodeAt(e.position + 1), te = e.line, (ee === 63 || ee === 58) && O(re))
        ee === 63 ? (X && (ce(e, me, R, k, V, null, Z, ae, le), k = V = z = null), ie = !0, X = !0, W = !0) : X ? (X = !1, W = !0) : I(e, "incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"), e.position += 1, ee = re;
      else {
        ...
        if (e.line === te) {
          ...
          if (ee === 58)
            ee = e.input.charCodeAt(++e.position), O(ee) || I(e, "a whitespace character is expected after the key-value separator within a block mapping"), X && (ce(e, me, R, k, V, null, Z, ae, le), k = V = z = null), ie = !0, X = !1, W = !1, k = e.tag, V = e.result;
          else if (ie)
      ...
      if ((e.line === te || e.lineIndent > B) && (X && (Z = e.line, ae = e.lineStart, le = e.position), Ae(e, B, i, !0, W) && (X ? V = e.result : z = e.result), X || (ce(e, me, R, k, V, z, Z, ae, le), k = V = z = null), Ee(e, !0, -1), ee = e.input.charCodeAt(e.position)), (e.line === te || e.lineIndent > B) && ee !== 0)
        I(e, "bad indentation of a mapping entry");
      else if (e.lineIndent < B)
        break;
    }
    return X && ce(e, me, R, k, V, null, Z, ae, le), ie && (e.tag = Re, e.anchor = Te, e.kind = "mapping", e.result = me), ie;
  }
  function _e(e) {
  ...
  function Ae(e, B, G, re, W) {
    var te, Z, ae, le = 1, Re = !1, Te = !1, me, R, k, V, z, X;
    ...
    if (ae && (ae = Re || W), (le === 1 || i === G) && (l === G || a === G ? z = B : z = B + 1, X = e.position - e.lineStart, le === 1 ? ae && (he(e, X) || pe(e, X, z)) || N(e, z) ? Te = !0 : (Z && ue(e, z) || g(e, z) || H(e, z) ? Te = !0 : He(e) ? (Te = !0, (e.tag !== null || e.anchor !== null) && I(e, "alias node should not have any properties")) : w(e, z, l === G) && (Te = !0, e.tag === null && (e.tag = "?")), e.anchor !== null && (e.anchorMap[e.anchor] = e.result)) : le === 0 && (Te = ae && he(e, X))), e.tag === null)
      ...
      if (c.call(e.typeMap[e.kind || "fallback"], e.tag))
        ...
        for (V = null, k = e.typeMap.multi[e.kind || "fallback"], me = 0, R = k.length; me < R; me += 1)
...
`), e.charCodeAt(0) === 65279 && (e = e.slice(1)));
  ...
  return Lr.loadAll = it, Lr.load = tt, Lr;
}
var ri = {}, Vo;
function Wc() {
  if (Vo) return ri;
  Vo = 1;
  var t = gr(), f = vr(), h = ta(), u = Object.prototype.toString, c = Object.prototype.hasOwnProperty, l = 65279, a = 9, d = 10, i = 13, s = 32, r = 33, o = 34, n = 35, m = 37, v = 38, y = 39, p = 42, S = 44, T = 45, P = 58, O = 61, M = 62, C = 63, _ = 64, A = 91, E = 93, q = 96, U = 123, L = 124, $ = 125, D = {};
  ...
  function I(R, k) {
    ...
    for (V = {}, z = Object.keys(k), X = 0, ie = z.length; X < ie; X += 1)
      ee = z[X], oe = String(k[ee]), ee.slice(0, 2) === "!!" && (ee = "tag:yaml.org,2002:" + ee.slice(2)), fe = R.compiledTypeMap.fallback[ee], fe && c.call(fe.styleAliases, oe) && (oe = fe.styleAliases[oe]), V[ee] = oe;
    return V;
  }
  function Q(R) {
    var k, V, z;
    if (k = R.toString(16).toUpperCase(), R <= 255)
      V = "x", z = 2;
    else if (R <= 65535)
      V = "u", z = 4;
  ...
  function ce(R, k) {
    for (var V = t.repeat(" ", k), z = 0, X = -1, ie = "", ee, oe = R.length; z < oe; )
      X = R.indexOf(`
...
` + t.repeat(" ", R.indent * k);
  ...
  function Ee(R, k) {
    ...
    for (V = 0, z = R.implicitTypes.length; V < z; V += 1)
      if (X = R.implicitTypes[V], X.resolve(k))
        return !0;
    return !1;
  }
  function J(R) {
  ...
  function g(R, k, V) {
    ...
    return (
      ...
      (V ? (
        // c = flow-in
        z
      ) : z && R !== S && R !== A && R !== E && R !== U && R !== $) && R !== n && !(k === P && !X) || w(k) && !J(k) && R === n || k === P && X
    );
  }
  function H(R) {
    return ve(R) && R !== l && !J(R) && R !== T && R !== C && R !== P && R !== S && R !== A && R !== E && R !== U && R !== $ && R !== n && R !== v && R !== p && R !== r && R !== L && R !== O && R !== M && R !== y && R !== o && R !== m && R !== _ && R !== q;
  }
  function N(R) {
    return !J(R) && R !== P;
  }
  function ue(R, k) {
    var V = R.charCodeAt(k), z;
    return V >= 55296 && V <= 56319 && k + 1 < R.length && (z = R.charCodeAt(k + 1), z >= 56320 && z <= 57343) ? (V - 55296) * 1024 + z - 56320 + 65536 : V;
  }
  function he(R) {
    var k = /^\n* /;
    return k.test(R);
  ...
  function $e(R, k, V, z, X, ie, ee, oe) {
    var fe, we = 0, be = null, De = !1, Ce = !1, It = z !== -1, Ke = -1, gt = H(ue(R, 0)) && N(ue(R, R.length - 1));
    if (k || ee)
    ...
    return !De && !Ce ? gt && !ee && !X(R) ? pe : ie === ne ? Ae : _e : V > 9 && he(R) ? Ae : ee ? ie === ne ? Ae : _e : Ce ? He : ye;
  }
  function lt(R, k, V, z, X) {
    R.dump = (function() {
      if (k.length === 0)
        return R.quotingType === ne ? '""' : "''";
      if (!R.noCompatMode && (F.indexOf(k) !== -1 || j.test(k)))
        return R.quotingType === ne ? '"' + k + '"' : "'" + k + "'";
      ...
      switch ($e(
        ...
        case _e:
          return "'" + k.replace(/'/g, "''") + "'";
        case ye:
          return "|" + it(k, R.indent) + tt(ce(k, ie));
        case He:
          return ">" + it(k, R.indent) + tt(ce(e(k, ee), ie));
        case Ae:
          return '"' + G(k) + '"';
        default:
  ...
  function it(R, k) {
    var V = he(R) ? String(k) : "", z = R[R.length - 1] === `
`, X = z && (R[R.length - 2] === `
` || R === `
`), ie = X ? "+" : z ? "" : "-";
    return V + ie + `
...
` ? R.slice(0, -1) : R;
  ...
  function e(R, k) {
    for (var V = /(\n+)([^\n]*)/g, z = (function() {
      var we = R.indexOf(`
`);
      return we = we !== -1 ? we : R.length, V.lastIndex = we, B(R.slice(0, we), k);
    })(), X = R[0] === `
...
` + R.slice(X, ie), X = ie + 1), ee = oe;
    return fe += `
`, R.length - X > k && ee > X ? fe += R.slice(X, ee) + `
` + R.slice(ee + 1) : fe += R.slice(X), fe.slice(1);
  }
  function G(R) {
    for (var k = "", V = 0, z, X = 0; X < R.length; V >= 65536 ? X += 2 : X++)
      V = ue(R, X), z = D[V], !z && ve(V) ? (k += R[X], V >= 65536 && (k += R[X + 1])) : k += z || Q(V);
    return k;
  }
  function re(R, k, V) {
    var z = "", X = R.tag, ie, ee, oe;
    for (ie = 0, ee = V.length; ie < ee; ie += 1)
      oe = V[ie], R.replacer && (oe = R.replacer.call(V, String(ie), oe)), (le(R, k, oe, !1, !1) || typeof oe > "u" && le(R, k, null, !1, !1)) && (z !== "" && (z += "," + (R.condenseFlow ? "" : " ")), z += R.dump);
    R.tag = X, R.dump = "[" + z + "]";
  }
  function W(R, k, V, z) {
    var X = "", ie = R.tag, ee, oe, fe;
    for (ee = 0, oe = V.length; ee < oe; ee += 1)
      fe = V[ee], R.replacer && (fe = R.replacer.call(V, String(ee), fe)), (le(R, k + 1, fe, !0, !0, !1, !0) || typeof fe > "u" && le(R, k + 1, null, !0, !0, !1, !0)) && ((!z || X !== "") && (X += ge(R, k)), R.dump && d === R.dump.charCodeAt(0) ? X += "-" : X += "- ", X += R.dump);
    R.tag = ie, R.dump = X || "[]";
  }
  function te(R, k, V) {
    var z = "", X = R.tag, ie = Object.keys(V), ee, oe, fe, we, be;
    for (ee = 0, oe = ie.length; ee < oe; ee += 1)
      be = "", z !== "" && (be += ", "), R.condenseFlow && (be += '"'), fe = ie[ee], we = V[fe], R.replacer && (we = R.replacer.call(V, fe, we)), le(R, k, fe, !1, !1) && (R.dump.length > 1024 && (be += "? "), be += R.dump + (R.condenseFlow ? '"' : "") + ":" + (R.condenseFlow ? "" : " "), le(R, k, we, !1, !1) && (be += R.dump, z += be));
    R.tag = X, R.dump = "{" + z + "}";
  }
  function Z(R, k, V, z) {
    var X = "", ie = R.tag, ee = Object.keys(V), oe, fe, we, be, De, Ce;
    if (R.sortKeys === !0)
      ee.sort();
    ...
    for (oe = 0, fe = ee.length; oe < fe; oe += 1)
      Ce = "", (!z || X !== "") && (Ce += ge(R, k)), we = ee[oe], be = V[we], R.replacer && (be = R.replacer.call(V, we, be)), le(R, k + 1, we, !0, !0, !0) && (De = R.tag !== null && R.tag !== "?" || R.dump && R.dump.length > 1024, De && (R.dump && d === R.dump.charCodeAt(0) ? Ce += "?" : Ce += "? "), Ce += R.dump, De && (Ce += ge(R, k)), le(R, k + 1, be, !0, De) && (R.dump && d === R.dump.charCodeAt(0) ? Ce += ":" : Ce += ": ", Ce += R.dump, X += Ce));
    R.tag = ie, R.dump = X || "{}";
  }
  function ae(R, k, V) {
    var z, X, ie, ee, oe, fe;
    for (X = V ? R.explicitTypes : R.implicitTypes, ie = 0, ee = X.length; ie < ee; ie += 1)
      if (oe = X[ie], (oe.instanceOf || oe.predicate) && (!oe.instanceOf || typeof k == "object" && k instanceof oe.instanceOf) && (!oe.predicate || oe.predicate(k))) {
        if (V ? oe.multi && oe.representName ? R.tag = oe.representName(k) : R.tag = oe.tag : R.tag = "?", oe.represent) {
  ...
  function le(R, k, V, z, X, ie, ee) {
    R.tag = null, R.dump = V, ae(R, V, !1) || ae(R, V, !0);
    var oe = u.call(R.dump), fe = z, we;
    z && (z = R.flowLevel < 0 || R.flowLevel > k);
    var be = oe === "[object Object]" || oe === "[object Array]", De, Ce;
    if (be && (De = R.duplicates.indexOf(V), Ce = De !== -1), (R.tag !== null && R.tag !== "?" || Ce || R.indent !== 2 && k > 0) && (X = !1), Ce && R.usedDuplicates[De])
      R.dump = "*ref_" + De;
    else {
      if (be && Ce && !R.usedDuplicates[De] && (R.usedDuplicates[De] = !0), oe === "[object Object]")
        z && Object.keys(R.dump).length !== 0 ? (Z(R, k, R.dump, X), Ce && (R.dump = "&ref_" + De + R.dump)) : (te(R, k, R.dump), Ce && (R.dump = "&ref_" + De + " " + R.dump));
      else if (oe === "[object Array]")
        z && R.dump.length !== 0 ? (R.noArrayIndent && !ee && k > 0 ? W(R, k - 1, R.dump, X) : W(R, k, R.dump, X), Ce && (R.dump = "&ref_" + De + R.dump)) : (re(R, k, R.dump), Ce && (R.dump = "&ref_" + De + " " + R.dump));
      else if (oe === "[object String]")
        R.tag !== "?" && lt(R, R.dump, k, ie, fe);
      else {
  ...
  function Te(R, k, V) {
    ...
    if (R !== null && typeof R == "object")
      if (X = k.indexOf(R), X !== -1)
        V.indexOf(X) === -1 && V.push(X);
      else if (k.push(R), Array.isArray(R))
...
function ra() {
  ...
  return qe.Type = Me(), qe.Schema = Nl(), qe.FAILSAFE_SCHEMA = Ul(), qe.JSON_SCHEMA = Bl(), qe.CORE_SCHEMA = Hl(), qe.DEFAULT_SCHEMA = ta(), qe.load = t.load, qe.loadAll = t.loadAll, qe.dump = f.dump, qe.YAMLException = vr(), qe.types = {
    binary: Wl(),
    float: Ml(),
    map: Ll(),
    null: kl(),
...
function Vc() {
  if (zo) return Xt;
  zo = 1, Object.defineProperty(Xt, "__esModule", { value: !0 }), Xt.Lazy = void 0;
  class t {
    constructor(h) {
...
var ii, Ko;
function Gr() {
  return Ko || (Ko = 1, ii = typeof process == "object" && process.env && process.env.NODE_DEBUG && /\bsemver\b/i.test(process.env.NODE_DEBUG) ? (...f) => console.error("SEMVER", ...f) : () => {
  }), ii;
}
var Jo;
function Er() {
  return Jo || (Jo = 1, (function(t, f) {
    const {
...
function na() {
  ...
  return ai = (u) => u ? typeof u != "object" ? t : u : f, ai;
}
var oi, Zo;
function Xl() {
  if (Zo) return oi;
...
function Be() {
  if (es) return si;
  es = 1;
  const t = Gr(), { MAX_LENGTH: f, MAX_SAFE_INTEGER: h } = jr(), { safeRe: u, t: c } = Er(), l = na(), { compareIdentifiers: a } = Xl();
  class d {
    constructor(s, r) {
...
function Jc() {
  ...
  os = 1;
  const t = Be();
  return hi = (h, u) => new t(h, u).major, hi;
}
var pi, ss;
function Qc() {
  if (ss) return pi;
  ss = 1;
  const t = Be();
  return pi = (h, u) => new t(h, u).minor, pi;
}
var mi, ls;
function Zc() {
  if (ls) return mi;
  ls = 1;
  const t = Be();
  return mi = (h, u) => new t(h, u).patch, mi;
}
var gi, us;
function ef() {
  if (us) return gi;
...
function Ze() {
  ...
  cs = 1;
  const t = Be();
  return vi = (h, u, c) => new t(h, c).compare(new t(u, c)), vi;
}
var Ei, fs;
function tf() {
  if (fs) return Ei;
...
function nf() {
  ...
  ps = 1;
  const t = ia();
  return _i = (h, u) => h.sort((c, l) => t(c, l, u)), _i;
}
var Si, ms;
function af() {
  if (ms) return Si;
  ms = 1;
  const t = ia();
  return Si = (h, u) => h.sort((c, l) => t(l, c, u)), Si;
}
var Ai, gs;
function Wr() {
  if (gs) return Ai;
...
function Ql() {
  if (Ss) return Oi;
  Ss = 1;
  const t = Kl(), f = Jl(), h = Wr(), u = oa(), c = aa(), l = sa();
  return Oi = (d, i, s, r) => {
    switch (i) {
      case "===":
...
function of() {
  if (As) return Ii;
  As = 1;
  const t = Be(), f = Bt(), { safeRe: h, t: u } = Er();
  return Ii = (l, a) => {
    if (l instanceof t)
      return l;
...
function et() {
  ...
  Ni = f;
  const h = sf(), u = new h(), c = na(), l = Vr(), a = Gr(), d = Be(), {
    safeRe: i,
    t: s,
    comparatorTrimReplace: r,
    tildeTrimReplace: o,
    caretTrimReplace: n
  } = Er(), { FLAG_INCLUDE_PRERELEASE: m, FLAG_LOOSE: v } = jr(), y = (D) => D.value === "<0.0.0-0", p = (D) => D.value === "", S = (D, F) => {
    let j = !0;
    const I = D.slice();
    let Q = I.pop();
    for (; j && I.length; )
    ...
    return j;
  }, T = (D, F) => (D = D.replace(i[s.BUILD], ""), a("comp", D, F), D = C(D, F), a("caret", D), D = O(D, F), a("tildes", D), D = A(D, F), a("xrange", D), D = q(D, F), a("stars", D), D), P = (D) => !D || D.toLowerCase() === "x" || D === "*", O = (D, F) => D.trim().split(/\s+/).map((j) => M(j, F)).join(" "), M = (D, F) => {
...
function Vr() {
  ...
  Fi = f;
  const h = na(), { safeRe: u, t: c } = Er(), l = Ql(), a = Gr(), d = Be(), i = et();
  return Fi;
}
var xi, bs;
function Yr() {
...
function lf() {
  ...
  Ps = 1;
  const t = et();
  return Li = (h, u) => new t(h, u).set.map((c) => c.map((l) => l.value).join(" ").trim().split(" ")), Li;
}
var Ui, Os;
function uf() {
  if (Os) return Ui;
...
function la() {
  if (Fs) return Mi;
  Fs = 1;
  const t = Be(), f = Vr(), { ANY: h } = f, u = et(), c = Yr(), l = Wr(), a = aa(), d = sa(), i = oa();
  return Mi = (r, o, n, m) => {
...
function mf() {
  ...
  Us = 1;
  const t = et();
  return ji = (h, u, c) => (h = new t(h, c), u = new t(u, c), h.intersects(u, c)), ji;
}
var Gi, ks;
function gf() {
  if (ks) return Gi;
...
function vf() {
  if (qs) return Wi;
  qs = 1;
  const t = et(), f = Vr(), { ANY: h } = f, u = Yr(), c = Ze(), l = (o, n, m = {}) => {
    if (o === n)
      return !0;
...
function Zl() {
  if ($s) return Vi;
  $s = 1;
  const t = Er(), f = jr(), h = Be(), u = Xl(), c = Bt(), l = Yc(), a = zc(), d = Xc(), i = Kc(), s = Jc(), r = Qc(), o = Zc(), n = ef(), m = Ze(), v = tf(), y = rf(), p = ia(), S = nf(), T = af(), P = Wr(), O = aa(), M = Kl(), C = Jl(), _ = oa(), A = sa(), E = Ql(), q = of(), U = Vr(), L = et(), $ = Yr(), D = lf(), F = uf(), j = cf(), I = ff(), Q = df(), Y = la(), ne = hf(), de = pf(), ce = mf(), ge = gf(), Ee = vf();
  return Vi = {
    parse: c,
    valid: l,
    clean: a,
...
var Ms;
function Ef() {
  return Ms || (Ms = 1, (function(t, f) {
    var h = 200, u = "__lodash_hash_undefined__", c = 1, l = 2, a = 9007199254740991, d = "[object Arguments]", i = "[object Array]", s = "[object AsyncFunction]", r = "[object Boolean]", o = "[object Date]", n = "[object Error]", m = "[object Function]", v = "[object GeneratorFunction]", y = "[object Map]", p = "[object Number]", S = "[object Null]", T = "[object Object]", P = "[object Promise]", O = "[object Proxy]", M = "[object RegExp]", C = "[object Set]", _ = "[object String]", A = "[object Symbol]", E = "[object Undefined]", q = "[object WeakMap]", U = "[object ArrayBuffer]", L = "[object DataView]", $ = "[object Float32Array]", D = "[object Float64Array]", F = "[object Int8Array]", j = "[object Int16Array]", I = "[object Int32Array]", Q = "[object Uint8Array]", Y = "[object Uint8ClampedArray]", ne = "[object Uint16Array]", de = "[object Uint32Array]", ce = /[\\^$.*+?()[\]{}|]/g, ge = /^\[object .+?Constructor\]$/, Ee = /^(?:0|[1-9]\d*)$/, J = {};
    J[$] = J[D] = J[F] = J[j] = J[I] = J[Q] = J[Y] = J[ne] = J[de] = !0, J[d] = J[i] = J[U] = J[r] = J[L] = J[o] = J[n] = J[m] = J[y] = J[p] = J[T] = J[M] = J[C] = J[_] = J[q] = !1;
    var ve = typeof Qe == "object" && Qe && Qe.Object === Object && Qe, w = typeof self == "object" && self && self.Object === Object && self, g = ve || w || Function("return this")(), H = f && !f.nodeType && f, N = H && !0 && t && !t.nodeType && t, ue = N && N.exports === H, he = ue && ve.process, pe = (function() {
      try {
    ...
    ), R = ue ? g.Buffer : void 0, k = g.Symbol, V = g.Uint8Array, z = te.propertyIsEnumerable, X = re.splice, ie = k ? k.toStringTag : void 0, ee = Object.getOwnPropertySymbols, oe = R ? R.isBuffer : void 0, fe = B(Object.keys, Object), we = Dt(g, "DataView"), be = Dt(g, "Map"), De = Dt(g, "Promise"), Ce = Dt(g, "Set"), It = Dt(g, "WeakMap"), Ke = Dt(Object, "create"), gt = yt(we), lu = yt(be), uu = yt(De), cu = yt(Ce), fu = yt(It), fa = k ? k.prototype : void 0, zr = fa ? fa.valueOf : void 0;
    function vt(b) {
    ...
    vt.prototype.clear = du, vt.prototype.delete = hu, vt.prototype.get = pu, vt.prototype.has = mu, vt.prototype.set = gu;
    function at(b) {
      var x = -1, K = b == null ? 0 : b.length;
      for (this.clear(); ++x < K; ) {
        var se = b[x];
    ...
    function wu(b) {
      return wr(this.__data__, b) > -1;
    }
    function _u(b, x) {
      var K = this.__data__, se = wr(K, b);
      return se < 0 ? (++this.size, K.push([b, x])) : K[se][1] = x, this;
    }
    at.prototype.clear = vu, at.prototype.delete = Eu, at.prototype.get = yu, at.prototype.has = wu, at.prototype.set = _u;
    function Et(b) {
      var x = -1, K = b == null ? 0 : b.length;
      for (this.clear(); ++x < K; ) {
        var se = b[x];
    ...
    function Au(b) {
      var x = _r(this, b).delete(b);
      return this.size -= x ? 1 : 0, x;
    }
    function Ru(b) {
      return _r(this, b).get(b);
    }
    function Tu(b) {
      return _r(this, b).has(b);
    }
    function Cu(b, x) {
      var K = _r(this, b), se = K.size;
      return K.set(b, x), this.size += K.size == se ? 0 : 1, this;
    }
    Et.prototype.clear = Su, Et.prototype.delete = Au, Et.prototype.get = Ru, Et.prototype.has = Tu, Et.prototype.set = Cu;
    function yr(b) {
      var x = -1, K = b == null ? 0 : b.length;
    ...
    yr.prototype.add = yr.prototype.push = bu, yr.prototype.has = Pu;
    function ut(b) {
    ...
    ut.prototype.clear = Ou, ut.prototype.delete = Iu, ut.prototype.get = Du, ut.prototype.has = Nu, ut.prototype.set = Fu;
    function xu(b, x) {
      var K = Sr(b), se = !K && Xu(b), Pe = !K && !se && Xr(b), Se = !K && !se && !Pe && wa(b), Ne = K || se || Pe || Se, Fe = Ne ? $e(b.length, String) : [], xe = Fe.length;
      for (var Oe in b)
    ...
    function Lu(b, x, K) {
      var se = x(b);
      return Sr(b) ? se : He(se, K(b));
    }
    function jt(b) {
      return b == null ? b === void 0 ? E : S : ie && ie in Object(b) ? Hu(b) : zu(b);
    }
    function da(b) {
      return Gt(b) && jt(b) == d;
    }
    function ha(b, x, K, se, Pe) {
      return b === x ? !0 : b == null || x == null || !Gt(b) && !Gt(x) ? b !== b && x !== x : Uu(b, x, K, se, ha, Pe);
    }
    function Uu(b, x, K, se, Pe, Se) {
      var Ne = Sr(b), Fe = Sr(x), xe = Ne ? i : ct(b), Oe = Fe ? i : ct(x);
      xe = xe == d ? T : xe, Oe = Oe == d ? T : Oe;
      ...
      if (Ue && !Ge)
        return Se || (Se = new ut()), Ne || wa(b) ? pa(b, x, K, se, Pe, Se) : Mu(b, x, xe, K, se, Pe, Se);
      if (!(K & c)) {
      ...
      return Ue ? (Se || (Se = new ut()), Bu(b, x, K, se, Pe, Se)) : !1;
    }
    function ku(b) {
      if (!ya(b) || Vu(b))
        return !1;
    ...
    function qu(b) {
      return Gt(b) && Ea(b.length) && !!J[jt(b)];
    }
    function $u(b) {
      if (!Yu(b))
        return fe(b);
    ...
    function pa(b, x, K, se, Pe, Se) {
      ...
      if (Oe && Se.get(x))
        return Oe == x;
      var Ge = -1, Je = !0, Ue = K & l ? new yr() : void 0;
      ...
      switch (K) {
        ...
        case C:
          ...
          if (Oe)
            return Oe == x;
          se |= l, Ne.set(b, x);
          var Ge = pa(Fe(b), Fe(x), se, Pe, Se, Ne);
    ...
    function Bu(b, x, K, se, Pe, Se) {
      var Ne = K & c, Fe = ma(b), xe = Fe.length, Oe = ma(x), Ge = Oe.length;
      if (xe != Ge && !Ne)
        return !1;
      for (var Je = xe; Je--; ) {
        var Ue = Fe[Je];
      ...
      for (var ft = Ne; ++Je < xe; ) {
        ...
        var ot = b[Ue], wt = x[Ue];
        if (se)
          var _a = Ne ? se(wt, ot, Ue, x, b, Se) : se(ot, wt, Ue, b, x, Se);
        if (!(_a === void 0 ? ot === wt || Pe(ot, wt, K, se, Se) : _a)) {
          ze = !1;
          break;
        }
      ...
      if (ze && !ft) {
        var Ar = b.constructor, Rr = x.constructor;
        Ar != Rr && "constructor" in b && "constructor" in x && !(typeof Ar == "function" && Ar instanceof Ar && typeof Rr == "function" && Rr instanceof Rr) && (ze = !1);
      }
    ...
    function _r(b, x) {
      var K = b.__data__;
      return Wu(x) ? K[typeof x == "string" ? "string" : "hash"] : K.map;
    }
    function Dt(b, x) {
      var K = tt(b, x);
    ...
    (we && ct(new we(new ArrayBuffer(1))) != L || be && ct(new be()) != y || De && ct(De.resolve()) != P || Ce && ct(new Ce()) != C || It && ct(new It()) != q) && (ct = function(b) {
      var x = jt(b), K = x == T ? b.constructor : void 0, se = K ? yt(K) : "";
      if (se)
        switch (se) {
          case gt:
            return L;
    ...
    var Xu = da(/* @__PURE__ */ (function() {
      return arguments;
    })()) ? da : function(b) {
      return Gt(b) && le.call(b, "callee") && !z.call(b, "callee");
    }, Sr = Array.isArray;
    function Ku(b) {
      return b != null && Ea(b.length) && !va(b);
    }
    var Xr = oe || ec;
    function Ju(b, x) {
      return ha(b, x);
...
function yf() {
  if (Bs) return Ft;
  Bs = 1, Object.defineProperty(Ft, "__esModule", { value: !0 }), Ft.DownloadedUpdateHelper = void 0, Ft.createTempUpdateFile = d;
  const t = mr, f = pt, h = Ef(), u = /* @__PURE__ */ mt(), c = Ie;
  let l = class {
    constructor(s) {
...
function wf() {
  if (Hs) return kr;
  Hs = 1, Object.defineProperty(kr, "__esModule", { value: !0 }), kr.getAppCacheDir = h;
  const t = Ie, f = Mr;
  function h() {
    const u = (0, f.homedir)();
    let c;
...
function _f() {
  if (js) return Kt;
  js = 1, Object.defineProperty(Kt, "__esModule", { value: !0 }), Kt.ElectronAppAdapter = void 0;
  const t = Ie, f = wf();
  let h = class {
  ...
  return Kt.ElectronAppAdapter = h, Kt;
}
var Yi = {}, Gs;
function Sf() {
...
function Af() {
  if (Ws) return zi;
  Ws = 1;
  var t = "[object Symbol]", f = /[\\^$.*+?()[\]{}|]/g, h = RegExp(f.source), u = typeof Qe == "object" && Qe && Qe.Object === Object && Qe, c = typeof self == "object" && self && self.Object === Object && self, l = u || c || Function("return this")(), a = Object.prototype, d = a.toString, i = l.Symbol, s = i ? i.prototype : void 0, r = s ? s.toString : void 0;
  function o(p) {
    if (typeof p == "string")
      return p;
    if (m(p))
...
function Pt() {
  if (Vs) return Tt;
  Vs = 1, Object.defineProperty(Tt, "__esModule", { value: !0 }), Tt.newBaseUrl = h, Tt.newUrlFromBase = u, Tt.getChannelFilename = c, Tt.blockmapFiles = l;
  const t = qt, f = Af();
  function h(a) {
    const d = new t.URL(a);
...
function Xe() {
  if (Ys) return st;
  Ys = 1, Object.defineProperty(st, "__esModule", { value: !0 }), st.Provider = void 0, st.findFile = c, st.parseUpdateInfo = l, st.getFileList = a, st.resolveFiles = d;
  const t = Le(), f = ra(), h = Pt();
  let u = class {
    constructor(s) {
...
function eu() {
  if (zs) return Jt;
  zs = 1, Object.defineProperty(Jt, "__esModule", { value: !0 }), Jt.GenericProvider = void 0;
  ...
  return Jt.GenericProvider = u, Jt;
}
var Qt = {}, Zt = {}, Xs;
function Rf() {
  if (Xs) return Zt;
  Xs = 1, Object.defineProperty(Zt, "__esModule", { value: !0 }), Zt.BitbucketProvider = void 0;
  const t = Le(), f = Pt(), h = Xe();
  let u = class extends h.Provider {
    constructor(l, a, d) {
      super({
  ...
  return Zt.BitbucketProvider = u, Zt;
}
var ht = {}, Ks;
function tu() {
  if (Ks) return ht;
  Ks = 1, Object.defineProperty(ht, "__esModule", { value: !0 }), ht.GitHubProvider = ht.BaseGitHubProvider = void 0, ht.computeReleaseNotes = s;
  const t = Le(), f = Zl(), h = qt, u = Pt(), c = Xe(), l = /\/tag\/([^/]+)$/;
...
function Tf() {
  if (Js) return er;
  Js = 1, Object.defineProperty(er, "__esModule", { value: !0 }), er.KeygenProvider = void 0;
  const t = Le(), f = Pt(), h = Xe();
  let u = class extends h.Provider {
    constructor(l, a, d) {
      super({
  ...
  return er.KeygenProvider = u, er;
}
var tr = {}, Qs;
function Cf() {
  if (Qs) return tr;
  Qs = 1, Object.defineProperty(tr, "__esModule", { value: !0 }), tr.PrivateGitHubProvider = void 0;
  const t = Le(), f = ra(), h = Ie, u = qt, c = Pt(), l = tu(), a = Xe();
  ...
  return tr.PrivateGitHubProvider = d, tr;
}
var Zs;
function bf() {
  if (Zs) return Qt;
  Zs = 1, Object.defineProperty(Qt, "__esModule", { value: !0 }), Qt.isUrlProbablySupportMultiRangeRequests = a, Qt.createClient = d;
  const t = Le(), f = Rf(), h = eu(), u = tu(), c = Tf(), l = Cf();
  function a(i) {
...
function ua() {
  if (el) return Lt;
  el = 1, Object.defineProperty(Lt, "__esModule", { value: !0 }), Lt.OperationKind = void 0, Lt.computeOperations = f;
  var t;
  (function(a) {
  ...
  function f(a, d, i) {
    ...
    const p = r.get(v);
    let S = 0;
    const { checksumToOffset: T, checksumToOldSize: P } = c(s.get(v), y.offset, i);
    let O = n.offset;
...
function ru() {
  if (tl) return xt;
  tl = 1, Object.defineProperty(xt, "__esModule", { value: !0 }), xt.DataSplitter = void 0, xt.copyData = a;
  const t = Le(), f = pt, h = pr, u = ua(), c = Buffer.from(`\r
\r
`);
  var l;
  (function(i) {
...
function Pf() {
  if (rl) return ir;
  rl = 1, Object.defineProperty(ir, "__esModule", { value: !0 }), ir.executeTasksUsingMultipleRangeRequests = u, ir.checkIsRangesSupported = l;
  const t = Le(), f = ru(), h = ua();
    ...
    if (n <= 1) {
      const S = (T) => {
        ...
        if (P.kind === h.OperationKind.COPY)
          (0, f.copyData)(P, i, d.oldFileFd, r, () => S(T));
        else {
...
function Of() {
  if (nl) return ar;
  nl = 1, Object.defineProperty(ar, "__esModule", { value: !0 }), ar.ProgressDifferentialDownloadCallbackTransform = void 0;
  const t = pr;
  var f;
  (function(u) {
  ...
  return ar.ProgressDifferentialDownloadCallbackTransform = h, ar;
}
var il;
function nu() {
  if (il) return nr;
  il = 1, Object.defineProperty(nr, "__esModule", { value: !0 }), nr.DifferentialDownloader = void 0;
  const t = Le(), f = /* @__PURE__ */ mt(), h = pt, u = ru(), c = qt, l = ua(), a = Pf(), d = Of();
  let i = class {
...
function If() {
  if (al) return rr;
  al = 1, Object.defineProperty(rr, "__esModule", { value: !0 }), rr.GenericDifferentialDownloader = void 0;
  const t = nu();
  ...
  return rr.GenericDifferentialDownloader = f, rr;
}
var Xi = {}, ol;
function Ot() {
...
function ca() {
  if (sl) return St;
  sl = 1, Object.defineProperty(St, "__esModule", { value: !0 }), St.NoOpLogger = St.AppUpdater = void 0;
  const t = Le(), f = mr, h = Mr, u = Cl, c = /* @__PURE__ */ mt(), l = ra(), a = Vc(), d = Ie, i = Zl(), s = yf(), r = _f(), o = Sf(), n = eu(), m = bf(), v = Pl, y = Pt(), p = If(), S = Ot();
  let T = class iu extends u.EventEmitter {
    /**
    ...
    checkForUpdatesAndNotify(C) {
      return this.checkForUpdates().then((_) => _ != null && _.downloadPromise ? (_.downloadPromise.then(() => {
        const A = iu.formatDownloadNotification(_.updateInfo.version, this.app.name, C);
...
function Ht() {
  if (ll) return Wt;
  ll = 1, Object.defineProperty(Wt, "__esModule", { value: !0 }), Wt.BaseUpdater = void 0;
  const t = $r, f = ca();
  ...
  return Wt.BaseUpdater = h, Wt;
}
var or = {}, sr = {}, ul;
function au() {
  if (ul) return sr;
  ul = 1, Object.defineProperty(sr, "__esModule", { value: !0 }), sr.FileWithEmbeddedBlockMapDifferentialDownloader = void 0;
  const t = /* @__PURE__ */ mt(), f = nu(), h = Pl;
  ...
  sr.FileWithEmbeddedBlockMapDifferentialDownloader = u;
  function c(a) {
...
function fl() {
  if (cl) return or;
  cl = 1, Object.defineProperty(or, "__esModule", { value: !0 }), or.AppImageUpdater = void 0;
  const t = Le(), f = $r, h = /* @__PURE__ */ mt(), u = pt, c = Ie, l = Ht(), a = au(), d = Xe(), i = Ot();
  ...
  return or.AppImageUpdater = s, or;
}
var lr = {}, dl;
function hl() {
  if (dl) return lr;
  dl = 1, Object.defineProperty(lr, "__esModule", { value: !0 }), lr.DebUpdater = void 0;
  const t = Ht(), f = Xe(), h = Ot();
  ...
  return lr.DebUpdater = u, lr;
}
var ur = {}, pl;
function ml() {
  if (pl) return ur;
  pl = 1, Object.defineProperty(ur, "__esModule", { value: !0 }), ur.PacmanUpdater = void 0;
  const t = Ht(), f = Ot(), h = Xe();
  let u = class extends t.BaseUpdater {
    constructor(l, a) {
      super(l, a);
    }
  ...
  return ur.PacmanUpdater = u, ur;
}
var cr = {}, gl;
function vl() {
  if (gl) return cr;
  gl = 1, Object.defineProperty(cr, "__esModule", { value: !0 }), cr.RpmUpdater = void 0;
  const t = Ht(), f = Ot(), h = Xe();
  let u = class extends t.BaseUpdater {
    constructor(l, a) {
      super(l, a);
  ...
  return cr.RpmUpdater = u, cr;
}
var fr = {}, El;
function yl() {
  if (El) return fr;
  El = 1, Object.defineProperty(fr, "__esModule", { value: !0 }), fr.MacUpdater = void 0;
  const t = Le(), f = /* @__PURE__ */ mt(), h = pt, u = Ie, c = ac, l = ca(), a = Xe(), d = $r, i = mr;
...
function Df() {
  if (wl) return qr;
  wl = 1, Object.defineProperty(qr, "__esModule", { value: !0 }), qr.verifySignature = c;
  const t = Le(), f = $r, h = Mr, u = Ie;
  function c(i, s, r) {
    return new Promise((o, n) => {
      const m = s.replace(/'/g, "''");
...
function Sl() {
  if (_l) return dr;
  _l = 1, Object.defineProperty(dr, "__esModule", { value: !0 }), dr.NsisUpdater = void 0;
  const t = Le(), f = Ie, h = Ht(), u = au(), c = Ot(), l = Xe(), a = /* @__PURE__ */ mt(), d = Df(), i = qt;
...
function Nf() {
  return Al || (Al = 1, (function(t) {
    var f = _t && _t.__createBinding || (Object.create ? (function(p, S, T, P) {
      P === void 0 && (P = T);
      ...
      for (var T in p) T !== "default" && !Object.prototype.hasOwnProperty.call(S, T) && f(S, p, T);
    };
    ...
    function y() {
      if (process.platform === "win32")
        v = new (Sl()).NsisUpdater();
      else if (process.platform === "darwin")
        v = new (yl()).MacUpdater();
      else {
        v = new (fl()).AppImageUpdater();
        try {
...
const ou = Ut.dirname(rc(import.meta.url));
process.env.DIST = Ut.join(ou, "../dist");
process.env.VITE_PUBLIC = kt.isPackaged ? process.env.DIST : Ut.join(process.env.DIST, "../public");
let rt;
function su() {
  rt = new Rl({
    icon: Ut.join(process.env.VITE_PUBLIC, "electron-vite.svg"),
    webPreferences: {
      preload: Ut.join(ou, "preload.mjs"),
      webSecurity: !1
      // Disable CORS for API requests
    }
  }), tc.defaultSession.webRequest.onBeforeSendHeaders(
  ...
  ), rt.webContents.on("did-finish-load", () => {
    rt == null || rt.webContents.send("main-process-message", (/* @__PURE__ */ new Date()).toLocaleString());
  }), process.env.VITE_DEV_SERVER_URL ? rt.loadURL(process.env.VITE_DEV_SERVER_URL) : rt.loadFile(Ut.join(process.env.DIST, "index.html"));
}
kt.on("window-all-closed", () => {
  process.platform !== "darwin" && (kt.quit(), rt = null);
});
kt.on("activate", () => {
  Rl.getAllWindows().length === 0 && su();
});
kt.whenReady().then(() => {
  su(), kt.isPackaged && rt && Ff(rt);
});
